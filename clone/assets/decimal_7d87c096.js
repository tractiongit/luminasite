...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<meta name="description" content="decimal.js CDN by jsDelivr - A free, fast, and reliable Open Source CDN for npm and GitHub">
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<title>decimal.js CDN by jsDelivr - A free, fast, and reliable Open Source CDN</title>
		<style>
			body {
			...
			.select-css {
				...
				appearance: none;
				background-color: #fff;
				background-image: url('caret-down-fill_e52694ab.svg');
	...
	<body>
		<div class="container">
			<div class="header">
				<h1>decimal.js CDN files</h1>

				<a class="badge" href="decimal_01615e07.js" title="jsDelivr monthly hits">
					<img alt="jsDelivr monthly hits badge" src="https://data.jsdelivr.com/v1/package/npm/decimal.js/badge">
				</a>
			</div>
			...
			<div class="path">
				<ol itemscope itemtype="https://schema.org/BreadcrumbList">
					<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
						<span itemprop="name">decimal.js@10.6.0</span>
						<meta itemprop="position" content="0">
					</li>
				</ol>

				<select class="versions select-css">
					<option value="decimal.js@10.6.0">decimal.js@10.6.0</option>
					<option value="decimal.js@10.5.0">decimal.js@10.5.0</option>
					<option value="decimal.js@10.4.3">decimal.js@10.4.3</option>
					<option value="decimal.js@10.4.2">decimal.js@10.4.2</option>
					<option value="decimal.js@10.4.1">decimal.js@10.4.1</option>
					<option value="decimal.js@10.4.0">decimal.js@10.4.0</option>
					<option value="decimal.js@10.3.1">decimal.js@10.3.1</option>
					<option value="decimal.js@10.3.0">decimal.js@10.3.0</option>
					<option value="decimal.js@10.2.1">decimal.js@10.2.1</option>
					<option value="decimal.js@10.2.0">decimal.js@10.2.0</option>
					<option value="decimal.js@10.1.1">decimal.js@10.1.1</option>
					<option value="decimal.js@10.0.2">decimal.js@10.0.2</option>
					<option value="decimal.js@10.0.1">decimal.js@10.0.1</option>
					<option value="decimal.js@10.0.0">decimal.js@10.0.0</option>
					<option value="decimal.js@9.0.1">decimal.js@9.0.1</option>
					<option value="decimal.js@9.0.0">decimal.js@9.0.0</option>
					<option value="decimal.js@8.0.0">decimal.js@8.0.0</option>
					<option value="decimal.js@7.5.1">decimal.js@7.5.1</option>
					<option value="decimal.js@7.5.0">decimal.js@7.5.0</option>
					<option value="decimal.js@7.4.0">decimal.js@7.4.0</option>
					<option value="decimal.js@7.3.0">decimal.js@7.3.0</option>
					<option value="decimal.js@7.2.4">decimal.js@7.2.4</option>
					<option value="decimal.js@7.2.3">decimal.js@7.2.3</option>
					<option value="decimal.js@7.2.2">decimal.js@7.2.2</option>
					<option value="decimal.js@7.2.1">decimal.js@7.2.1</option>
					<option value="decimal.js@7.2.0">decimal.js@7.2.0</option>
					<option value="decimal.js@7.1.2">decimal.js@7.1.2</option>
					<option value="decimal.js@7.1.1">decimal.js@7.1.1</option>
					<option value="decimal.js@7.1.0">decimal.js@7.1.0</option>
					<option value="decimal.js@7.0.0">decimal.js@7.0.0</option>
					<option value="decimal.js@6.0.0">decimal.js@6.0.0</option>
					<option value="decimal.js@5.0.8">decimal.js@5.0.8</option>
					<option value="decimal.js@5.0.7">decimal.js@5.0.7</option>
					<option value="decimal.js@5.0.6">decimal.js@5.0.6</option>
					<option value="decimal.js@5.0.5">decimal.js@5.0.5</option>
					<option value="decimal.js@5.0.4">decimal.js@5.0.4</option>
					<option value="decimal.js@5.0.3">decimal.js@5.0.3</option>
					<option value="decimal.js@5.0.2">decimal.js@5.0.2</option>
					<option value="decimal.js@5.0.1">decimal.js@5.0.1</option>
					<option value="decimal.js@5.0.0">decimal.js@5.0.0</option>
					<option value="decimal.js@4.0.4">decimal.js@4.0.4</option>
					<option value="decimal.js@4.0.3">decimal.js@4.0.3</option>
					<option value="decimal.js@4.0.2">decimal.js@4.0.2</option>
					<option value="decimal.js@4.0.1">decimal.js@4.0.1</option>
					<option value="decimal.js@4.0.0">decimal.js@4.0.0</option>
					<option value="decimal.js@3.0.1">decimal.js@3.0.1</option>
					<option value="decimal.js@3.0.0">decimal.js@3.0.0</option>
					<option value="decimal.js@2.0.3">decimal.js@2.0.3</option>
					<option value="decimal.js@2.0.2">decimal.js@2.0.2</option>
					<option value="decimal.js@2.0.1">decimal.js@2.0.1</option>
					<option value="decimal.js@2.0.0">decimal.js@2.0.0</option>
					<option value="decimal.js@1.0.1">decimal.js@1.0.1</option>
					<option value="decimal.js@1.0.0">decimal.js@1.0.0</option>
				</select>
			</div>
				...
				<table>
					...
					<tr>
						<td class="name">
							...
							<a rel="nofollow" href="/npm/decimal.js@10.6.0/decimal.d.ts">decimal.d.ts</a>
						</td>
						<td class="size">8.81 KB</td>
					</tr>
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 4C4 2.89543 4.89543 2 6 2H11L16 7V16C16 17.1046 15.1046 18 14 18H6C4.89543 18 4 17.1046 4 16V4Z" stroke="#5C667A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
							<a rel="nofollow" href="/npm/decimal.js@10.6.0/decimal.js">decimal.js</a>
						</td>
						<td class="size">133.47 KB</td>
					</tr>
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 4C4 2.89543 4.89543 2 6 2H11L16 7V16C16 17.1046 15.1046 18 14 18H6C4.89543 18 4 17.1046 4 16V4Z" stroke="#5C667A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
							<a rel="nofollow" href="/npm/decimal.js@10.6.0/decimal.mjs">decimal.mjs</a>
						</td>
						<td class="size">124.79 KB</td>
					</tr>
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 4C4 2.89543 4.89543 2 6 2H11L16 7V16C16 17.1046 15.1046 18 14 18H6C4.89543 18 4 17.1046 4 16V4Z" stroke="#5C667A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
							<a rel="nofollow" href="/npm/decimal.js@10.6.0/LICENCE.md">LICENCE.md</a>
						</td>
					...
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 4C4 2.89543 4.89543 2 6 2H11L16 7V16C16 17.1046 15.1046 18 14 18H6C4.89543 18 4 17.1046 4 16V4Z" stroke="#5C667A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
							<a rel="nofollow" href="/npm/decimal.js@10.6.0/package.json">package.json</a>
						</td>
					...
					<tr>
						<td class="name">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 4C4 2.89543 4.89543 2 6 2H11L16 7V16C16 17.1046 15.1046 18 14 18H6C4.89543 18 4 17.1046 4 16V4Z" stroke="#5C667A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
							<a rel="nofollow" href="/npm/decimal.js@10.6.0/README.md">README.md</a>
						</td>
						<td class="size">8.37 KB</td>
					</tr>
					</tbody>
				</table>
			</div>
			...
			<div class="landing">
				<p class="left">Free Open Source CDN for <strong>decimal.js</strong></p>

				<p class="right">
					Looking for a nice landing page for your package?
					<a href="decimal_01615e07.js">decimal_01615e07.js</a>
				</p>
			</div>
		</div>
		...
		<script>
			...
			[].slice.call(versions.querySelectorAll('option')).forEach(function(option) {
				if (option.value === 'decimal.js@10.6.0') {
